...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("Hyperparameter Setting for QMIX,VDN and BAVDM in SMAC environment")
    ...
    parser.add_argument("--algorithm", type=str, default="BAVDM", help="QMIX or VDN")
    ...
    parser.add_argument("--seed", type=int, default=1002, help="random seed")
    ...
    # save path
    parser.add_argument('--save_path', type=str, default='./result/bavdm')
    parser.add_argument('--model_path', type=str, default='./model/bavdm')
